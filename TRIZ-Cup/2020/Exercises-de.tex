...
Die Entwicklungsgesetze technischer Systeme sind eine der Grundlagen von
...
(A2) {\law{4}{Gesetz der Erhöhung der Vollständigkeit des Systems}};
...
(A5) {\law{3}{Gesetz der ungleichen Entwicklung von Systemteilen}};

\node[draw] at (10,0) [rectangle]
(A6) {\law{4}{Tendenz der Entwicklung technischer Systeme längs einer S-Kurve}};

\node[draw] at (0,0) [rectangle]
(A7) {\law{4}{Tendenz der Elimination menschlicher Eingriffe}};

\node[draw] at (10,4) [rectangle]
(A8) {\law{4}{Gesetz der zunehmenden Steuerbarkeit und Stoff-Feld-Interaktionen}};

\node[draw] at (5,1) [rectangle]
(A9) {\law{3}{Gesetz der wachsenden Dynamisierung}};

\node[draw] at (5,3) [rectangle]
(A10) {\law{3}{Gesetz des Übergangs zum Obersystem}};

\node[draw] at (10,6) [rectangle]
(A11) {\law{4}{Tendenz des Übergangs auf die Mikro-Ebene}};

\node[draw] at (10,2) [rectangle]
(A12) {\law{4}{Tendenz der Systemevolution durch Zusammenfall oder Zusammenführen}};
