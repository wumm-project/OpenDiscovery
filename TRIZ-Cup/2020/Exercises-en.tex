...
(A1) {\law{4}{Trend of increasing ideality}};

\node[draw] at (0,3.5) [rounded rectangle]
(A2) {\law{5}{Trend of increasing completeness (Trend of completeness of
...
(A5) {\law{5}{Trend of irregular evolution of system parts}};

\node[draw] at (5,2.2) [rounded rectangle]
(A6) {\law{5}{Tendency of system S-curve evolution}};

\node[draw] at (0,1) [rounded rectangle]
(A7) {\law{4}{Tendency of elemination of human involvement}};

\node[draw] at (8,7) [rounded rectangle]
(A8) {\law{4}{Trend of increasing controllability/Su-Field degree}};

\node[draw] at (10,8.5) [rounded rectangle]
(A9) {\law{4}{Trend of increasing dynamicity}};

\node[draw] at (10,3.5) [rounded rectangle]
(A10) {\law{4}{Trend of transition to the super-system}};
