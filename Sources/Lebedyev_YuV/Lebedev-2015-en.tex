...
\begin{center}
  \begin{tikzpicture}[
      box/.style={draw,align=center,rounded corners=2pt,text width=4.5cm},
      >={Triangle[length=3pt 9, width=3pt 3]}]
    \node[box,fill=orange!70] at (6,10) (A1) {\textbf{The positive\\ effect of
        a flow}}; 
    \node[box,fill=orange!70] at (1,8) (B1) {Improvement of the
      \textbf{consumer}}; 
    \node[box,fill=orange!70] at (6,8) (B2) {Improvement of\\ the
      \textbf{source}}; 
    \node[box,fill=orange!70] at (11,8) (B3) {Improvement of the
      \textbf{channel}}; 
    \node[box, below = of B1] (C1) {
      \begin{itemize}[leftmargin=10pt]
      \item Preliminary saturation of the working area
      \item Convert the receiver to a better flow sensitivity
      \end{itemize}
    };
    \node[box, below = of B2] (C2) {
      \begin{itemize}[leftmargin=10pt]
...
\draw[->,line width=2pt,orange] (A1) -- (B1) ;
\draw[->,line width=2pt,orange] (A1) -- (B2) ;
\draw[->,line width=2pt,orange] (A1) -- (B3) ;
  \end{tikzpicture}
  
  \begin{tikzpicture}[
      box/.style={draw,align=center,rounded corners=2pt,text width=4.5cm},
      >={Triangle[length=3pt 9, width=3pt 3]}]
    \node[box,fill=orange!70] at (6,10) (A1) {\textbf{The negative\\ effect of
        a flow}}; 
    \node[box,fill=orange!70] at (1,8) (B1) {Improvement of the
      \textbf{consumer}}; 
    \node[box,fill=orange!70] at (6,8) (B2) {Improvement of\\ the
    ...
    \node[box, below = of B2] (C2) {      
      ...
      \item Insertion of a second flow to correct the damage from the first
        flow
...
\begin{center}
  ...
  \begin{tikzpicture}[
    ...
    \node[fill=orange!70, single arrow, below = of B2, rotate=180, text
      width=12cm, align=center] (C1) {\rotatebox{180}{The easy way (short
        solution)}} ;

    \node[fill=orange!70, single arrow, below = of C1, text width=12cm,
      align=center] {The effective way (long solution)} ;
