...
\begin{tikzpicture}[
  ...
  \node[draw] at (5,3.5) [rectangle] (A0) {\bbox{2}{Steuerungs- system}};
  \node[draw] at (2.5,2) [rectangle] (A1) {\bbox{2}{Antrieb}};
  \node[draw] at (5,2) [rectangle] (A2) {\bbox{2}{Transmission}};
  \node[draw] at (7.5,2) [rectangle] (A3) {\bbox{2}{Arbeitsorgan}};
  \node[draw] at (12,2) [rectangle] {\bbox{2}{Bearbeitetes Objekt}}; 
  \draw (0,2.5) node {\bbox{2}{Energie- ressourcen}}; 
...
\begin{tikzpicture}[rounded corners=2pt] 
  ...
  \node[draw=green] at (5.5,6.5) [rectangle] (A0) {\bbox{6}{Information über
      die Realisierung des technischen Prozesses}};
  \node[draw=green] at (13.5,6.5) [rectangle] (A1) {\bbox{6}{Wissen, wie mit
      dem System technischer Objekte zu arbeiten ist}};
  \node[draw=red] at (5,4) [rectangle] (A2) {\bbox{5}{Systeme, Objekte, Stoffe
      und Felder für die Aktionen des Operators}};
  \node[draw=red] at (5,2) [rectangle] (A3) {\bbox{5}{Systeme, Objekte, Stoffe
      und Felder für die Aktionen des Systems technischer Objekte}};
  \node[draw=blue] at (14,4) [rectangle] (A4) {\bbox{3}{Verarbeitungs-
      produkte}}; 
  \node[draw=blue] at (14,2) [rectangle] (A5) {\bbox{3}{Verarbeitungs-
      produkte}}; 
  \node[draw=blue, line width=2pt] at (10,4) [rectangle] (A6)
       {\bbox{2}{Operator}}; 
  \node[draw=blue, line width=2pt] at (10,2) [rectangle] (A7) {\bbox{2}{System
      technischer Objekte}}; 
  \node[draw,fill=blue!30] at (10,0) [rectangle] (A8) {\bbox{4}{Bearbeitetes
      Objekt}};
