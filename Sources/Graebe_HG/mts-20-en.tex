...
\bibitem{Graebe2020a} Hans-Gert Gräbe (2020a). Reader for the 16th
...
\bibitem{Graebe2020b} Hans-Gert Gräbe (2020b). Die Menschen und ihre
...
\bibitem{Zobel2016} D. Zobel, R. Hartmann (2016). Pattern of Invention.
  Second edition. Expert, racing.
\bibitem{Zobel2020} D. Zobel (2020). Contributions to the further development
  of TRIZ.  LIFIS Online 01/19/202020. DOI: \url{10.14625/zobel_20200119}
\end{thebibliography}
\end{document}


Since \cite{TESE2018} is not about the evolution of technical systems in
general, but rather draws conclusions from TRIZ theory on such an evolution,
we introduce the \emph{TRIZ theoretical body} (TTB) as another neighbouring
component, since it appears in its entirety as an undisputed unit.  Also the
MPVs of both systems differ significantly -- while the TTB focuses on
\emph{solving problems} we focus on the \emph{evolution in the world of
  technical systems}.
